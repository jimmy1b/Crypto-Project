 ...
 * @author Jimmy Best (Renamed to tester, added test code in main)
 */
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        //code for command line frontend
        	//user keyboard input
        	//file input
        ...
        //symdecrypt
        //testing
        final byte[] m = "This is the message".getBytes();
        final byte[] pw = "This is the password".getBytes();
        SymCryptogram sce = SymCryptogram.symEncrypt(m, pw);

        System.out.println("\nSym Encrypt String:\t" + new String(m));
        System.out.println(sce.toString());
        
        try {
			byte[] mm = SymCryptogram.symDecrypt(sce, pw);
	        System.out.println("Sym Decrypted: \t\t"+ new String(mm) + "\n");
		} catch (Exception e) {
...
//			e.getMessage();
        ...
        //keypairgen
//        System.out.println(ECPoint.r.toString());
//        System.out.println(ECPoint.G.toString());
//		System.out.println();
//		System.out.println(ECPoint.G.ecDouble().ecDouble().ecAdd(ECPoint.G.ecDouble()).ecAdd(ECPoint.G));
//		System.out.println();
//		System.out.println(ECPoint.G.ecAdd(ECPoint.G).ecAdd(ECPoint.G).ecAdd(ECPoint.G).ecAdd(ECPoint.G).ecAdd(ECPoint.G).ecAdd(ECPoint.G));
//		System.out.println();
//		System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(7)));
//		System.out.println(ECPoint.G.ecAdd(ECPoint.G.getOpposite()).toString());
////
//		ECPoint plsbe1 = ECPoint.G.ecMultiply(BigInteger.ONE);
//        System.out.println(plsbe1.toString());
//		ECPoint aa = ECPoint.G.ecMultiply(BigInteger.valueOf(10));
//        System.out.println(aa.toString());
//        ECPoint aaa = ECPoint.G.ecDouble().ecDouble().ecDouble().ecAdd(ECPoint.G.ecDouble());
//        System.out.println(aa.toString());
//        System.out.println(BigInteger.ONE.bitCount());
//        System.out.println(ECPoint.G.ecAdd(ECPoint.G).toString());
        
        KeyPair sV = KeyPair.generate(pw);
        System.out.println(sV.toString());
		System.out.println();  

//		System.out.println(new String(asciiStringToByteArray("asdf"))); 
//		System.out.println(new String("asdf".getBytes())); 
		
//		System.out.println("testing1:");  
//        final byte[] pww = "testing1".getBytes();
//		KeyPair sVv = KeyPair.generate(pww);
//        System.out.println(sVv.toString());
//		System.out.println();
//        byte[] s = sVv.s.toByteArray();
//        System.out.print("[");
//        for(int i = 0; i < s.length; i++) {
...
//        System.out.println(ECPoint.d.toString());
//        
//        BigInteger top = BigInteger.ONE.subtract(BigInteger.valueOf(18).pow(2)).mod(ECPoint.p);
//        BigInteger bot = BigInteger.valueOf(18).pow(2).multiply(BigInteger.valueOf(376914)).add(BigInteger.ONE).mod(ECPoint.p);
//        BigInteger inv = BigInteger.valueOf(18).pow(2).multiply(BigInteger.valueOf(376914)).add(BigInteger.ONE).modInverse(ECPoint.p);
//
...
//        
//
//        BigInteger topsr = ECPoint.sqrt(top, ECPoint.p, false);
//        System.out.println(topsr.toString());
//
//        BigInteger botsr = ECPoint.sqrt(bot, ECPoint.p, false);
//        System.out.println(botsr.toString());
//        
//        BigInteger invsr = ECPoint.sqrt(inv, ECPoint.p, false);
//        System.out.println(invsr.toString());
//        
//        //y?
//        BigInteger iii = topsr.multiply(invsr).divide(botsr).mod(ECPoint.p);
//        System.out.println(iii.toString());
////        BigInteger huh = ECPoint.sqrt(ahh, ECPoint.p, false);
////        System.out.println(huh.toString());
////        BigInteger hhhh = hhh.multiply(ahh).divide(ahsh);
////        System.out.println(hhhh.toString());
////        BigInteger huhh = ECPoint.sqrt(hhhh, ECPoint.p, false);
////        System.out.println(huhh.toString());
        
        //schnorrencrypt
        //schnorrdecrypt

//		System.out.println(ECPoint.p.toString());
//		System.out.println(ECPoint.r.toString());
		
// point multiplication testing
//		BigInteger s1 = BigInteger.valueOf(20);
//		BigInteger s2 = BigInteger.valueOf(-20);
//		BigInteger s3 = BigInteger.valueOf(44);
//		for(int i = 0; i < s1.bitLength() + 1; i++) {
//			if(s1.testBit(i)) {
//
//				System.out.print(1);
//			} else {
...
//		}
//		System.out.println();
//		for(int i = 0; i < s2.bitLength() + 1; i++) {
//			if(s2.testBit(i)) {
//
//				System.out.print(1);
//			} else {
...
//		}
//		System.out.println();
//		for(int i = 0; i < s3.bitLength() + 1; i++) {
//			if(s3.testBit(i)) {
//
//				System.out.print(1);
//			} else {
...
//		ECPoint t1t = ECPoint.G.ecMultiply(s1);
//		System.out.println(t1t.toString());
//		ECPoint t2t = ECPoint.G.ecMultiply(s2);
//		System.out.println(t2t.toString());
//		ECPoint t3t = ECPoint.G.ecMultiply(s3);
//		System.out.println(t3t.toString());
		
		ECCryptogram ece = ECCryptogram.ECEncrypt(m, sV.V);

        System.out.println("\nEC Encrypt String:\t" + new String(m));
        System.out.println(ece.toString());

		
        try {
			byte[] mmm = ECCryptogram.ECDecrypt(ece, pw);
	        System.out.println("EC Decrypted: \t\t"+ new String(mmm) + "\n");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
//			e.getMessage();
...
//        byte on = (byte) (1<<7);
//        BigInteger test = BigInteger.valueOf(on);
//        System.out.println(test.toString(2));
//        BigInteger test1 = test.multiply(BigInteger.valueOf(-1));
//        System.out.println(test1.toString(2));
//        System.out.println(test1.toString());
//        System.out.println(test1.bitLength());
//        for(int i = 0; i < test1.bitLength(); i++) {
//            System.out.println(test1.testBit(i));
//        }
//        System.out.println();
//        System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(-4)));
//        System.out.println(ECPoint.G.getOpposite().ecMultiply(BigInteger.valueOf(4)));
//        System.out.println();
//        System.out.println();
//        System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(4)));
//        System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(2)).ecAdd(ECPoint.G.ecMultiply(BigInteger.valueOf(2))));
//        System.out.println();
//        System.out.println();
//        System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(4)));
//        System.out.println(ECPoint.G.ecMultiply(BigInteger.valueOf(2)).ecMultiply(BigInteger.valueOf(2)));
//        System.out.println();
		ECSignature sig = ECSignature.sigGen(m, pw);
		try {
			ECSignature.sigVerify(sig, m, sV.V);
